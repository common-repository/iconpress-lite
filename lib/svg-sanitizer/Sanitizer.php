...
namespace IconPressLite__enshrined\svgSanitize;
...
use DOMDocument;
use IconPressLite__enshrined\svgSanitize\data\AllowedAttributes;
use IconPressLite__enshrined\svgSanitize\data\AllowedTags;
use IconPressLite__enshrined\svgSanitize\data\AttributeInterface;
use IconPressLite__enshrined\svgSanitize\data\TagInterface;

/**
 * Class Sanitizer
 *
 * @package IconPressLite__enshrined\svgSanitize
 */
class Sanitizer
{
    /**
